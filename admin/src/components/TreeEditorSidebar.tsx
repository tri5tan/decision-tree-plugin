...
export default function TreeEditorSidebar({
  IS_DEV,
  subModulesUrl,
  moduleId,
  setModuleId,
    ...
    >
      ...
      <details>
        ...
        <p style={{ fontSize: 10, color: CHROME.textSubtle, margin: "8px 0 12px" }}>
          Adjust the layout of the tree. Changes here also apply to the Decision Tree Viewer.
        </p>
            ...
            {(["narrow", "normal", "wide"] as NodeWidth[]).map((w) => (
              <button
                ...
                style={{
                  ...
                  padding: "4px 0",
                  fontSize: 10,
                  border: `1px solid ${layoutSettings.nodeWidth === w ? STATUS_COLORS.start : CHROME.panelBorder}`,
                  background: layoutSettings.nodeWidth === w ? STATUS_COLORS.start : CHROME.cardBg,
            ...
            {(["compact", "normal", "relaxed"] as const).map((s) => (
              <button
                ...
                style={{
                  ...
                  padding: "4px 0",
                  fontSize: 10,
                  border: `1px solid ${layoutSettings.spacing === s ? STATUS_COLORS.start : CHROME.panelBorder}`,
                  background: layoutSettings.spacing === s ? STATUS_COLORS.start : CHROME.cardBg,
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    padding: "4px 0",
                    fontSize: 10,
                    border: `1px solid ${isActive ? STATUS_COLORS.start : CHROME.panelBorder}`,
                    background: isActive ? STATUS_COLORS.start : CHROME.cardBg,
