    ...
    <div
      ...
      style={{
        ...
        borderTop:
          statusKey === "orphan"
            ? "2px dashed #c0392b"
            : `2px solid ${selected ? accentColor : "#e5e7eb"}`,
        borderRight:
          statusKey === "orphan"
            ? "2px dashed #c0392b"
            : `2px solid ${selected ? accentColor : "#e5e7eb"}`,
    ...
    >
      ...
      >
        ...
        >
          ...
          {fieldGroupId === "" ? (
            <div style={{ marginBottom: 20, fontSize: 11, color: "#c0392b", background: "#fde8e8", padding: 8, borderRadius: 3 }}>
              Select a field group first
            </div>
          ) : (
            <>              
              <select
          ...
          <p style={{ fontSize: 11, color: "#888", marginBottom: 6 }}>
            Click a node to inspect it. Fix issues by editing sub-modules
            directly.
          </p>
          {subModulesUrl && (
            <a
